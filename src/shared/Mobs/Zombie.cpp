...
// TODO: refactor with Creeper::getDesiredMove to avoid code duplication
glm::vec3 Zombie::getDesiredMove(const ICommonWorld &world, const std::vector<std::shared_ptr<Entity>> &players)
{
	...
	// 	// TODO: Add collision checks between zombie and player
...
glm::vec3 Zombie::getWanderMove(const ICommonWorld &world)
{
...
void Zombie::checkObstacleAndJump(const ICommonWorld &world, const glm::vec3 &direction)
{
...
void Zombie::calculateNewPosition(const ICommonWorld &world, const std::vector<std::shared_ptr<Entity>> &players)
{
