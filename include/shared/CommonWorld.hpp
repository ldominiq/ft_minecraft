...
class CommonWorld : public ICommonWorld{
	...
	public:
		...
		TargetType getTarget(const glm::vec3 &rayOrigin, const glm::vec3 &rayDir, glm::ivec3 &hitBlock, glm::ivec3& faceNormal, LivingEntity*& livingEntity, float maxDistance = 100);
